...
<div class="centered-content"> <div class="card" style="width: 100%; max-width: 600px; padding: 2em; text-align: left;">
        ...
        <form method="POST" action="{{ route('profile.update', $user->id_user) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <p style="font-size: 0.8em; color: gray;">If unchecked, only friends can see your posts.</p>
