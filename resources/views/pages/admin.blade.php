...
<div class="mx-auto bg-white rounded-lg shadow-md p-8 w-[70vw]">
        <div class="w-full overflow-y-auto">
                <div class= "flex gap-5 justify-around border-b-2 border-gray-200">
                    ...
                    <a href="{{ route('admin', ['type' => 'group']) }}" class="mt-0 text-xl text-gray-500 border-b-2 border-gray-200 pb-3 font-semibold {{ (isset($type) && $type === 'groups') ? 'text-gray-800 border-gray-800' : 'border-transparent' }}"> Moderate Groups</a>
                </div>
                ...
                @elseif(isset($type) && $type=='group')
                    @include('partials.groups-manage', ['groups' => $groups])
                @endif
        </div>
</div>
