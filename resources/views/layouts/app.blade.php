...
<body class="m-0 p-0 min-h-screen overflow-x-hidden bg-white text-gray-800 font-sans">
    ...
    <aside class="w-64 bg-blue-200 border-r border-gray-200 h-screen fixed top-0 left-0 flex flex-col p-5 z-[1000]">
        ...
        <nav class="flex flex-col gap-0.5 flex-grow">
            ...
            <a href="{{ route('home') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->is('/') || request()->routeIs('home') ? 'font-bold text-blue-600' : '' }}" title="Go to your feed">
                <i class="fa-solid fa-house w-8 text-xl text-center mr-2.5"></i> 
                Feed
            </a>

            <a href="{{ route('search.users') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('search.users') ? 'font-bold text-blue-600' : '' }}" title="Click here to search for users">
            ...
            @if(Auth::check())
                    ...
                    <a href="{{ route('post.create') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('post.create') ? 'font-bold text-blue-600' : '' }}" title="Click here to craete a post">
                        <i class="fa-solid fa-circle-plus w-8 text-xl text-center mr-2.5"></i> 
                        Create Post
                    </a>

                    <a href="{{ route('profile.show', Auth::user()->id_user) }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('profile.show', Auth::user()->id_user) ? 'font-bold text-blue-600' : '' }}" title="Go to your profile page">
                        <i class="fa-solid fa-user w-8 text-xl text-center mr-2.5"></i> 
                        My Profile
                    </a>

                    <a href="{{ route('groups.index') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('groups.index') ? 'font-bold text-blue-600' : '' }}" title="Go to your groups">
                    ...
                    <a href="{{ route('admin') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-orange-500 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('admin') ? 'font-bold text-blue-600' : '' }}" title="Go to your admin panel">
                        <i class="fa-solid fa-shield-halved w-8 text-xl text-center mr-2.5"></i>
                        Admin Panel
                    </a>
                    @endif

                    <a href="{{ route('settings.index') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('settings.index') ? 'font-bold text-blue-600' : '' }}" title="Go to settings">
                    ...
                    <form action="{{ route('logout') }}" method="POST" class="mt-2.5">
                        @csrf
                        <button type="submit" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 bg-transparent border-none w-full text-red-600 cursor-pointer text-base rounded-lg transition-colors hover:bg-gray-100 m-0" title="Click here to logout">
                ...
                @else
                    ...
                    <a href="{{ route('groups.index') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('groups.index') ? 'font-bold text-blue-600' : '' }}" title="Search and explore groups">
                        <i class="fa-solid fa-users w-8 text-xl text-center mr-2.5"></i> 
                        Groups
                    </a>

                    <a href="{{ route('login') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('login') ? 'font-bold text-blue-600' : '' }}" title="Click here to login to an existing account">
                        <i class="fa-solid fa-right-to-bracket w-8 text-xl text-center mr-2.5"></i> 
                        Login
                    </a>
                    <a href="{{ route('register') }}" class="hover:shadow-xl transition-shadow duration-200 flex items-center p-3 text-gray-800 no-underline text-base rounded-lg transition-colors hover:bg-gray-100 {{ request()->routeIs('register') ? 'font-bold text-blue-600' : '' }}" title="Click here to register a new account">
